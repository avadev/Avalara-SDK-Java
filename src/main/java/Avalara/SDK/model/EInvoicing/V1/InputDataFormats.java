...
public class InputDataFormats {
  ...
  public boolean equals(Object o) {
    ...
    InputDataFormats inputDataFormats = (InputDataFormats) o;
    return Objects.equals(this.format, inputDataFormats.format) &&
        Objects.equals(this.versions, inputDataFormats.versions);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputDataFormats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputDataFormats is not found in the empty JSON string", InputDataFormats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputDataFormats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputDataFormats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputDataFormats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputDataFormats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputDataFormats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputDataFormats.class));

       return (TypeAdapter<T>) new TypeAdapter<InputDataFormats>() {
           @Override
           public void write(JsonWriter out, InputDataFormats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputDataFormats read(JsonReader in) throws IOException {

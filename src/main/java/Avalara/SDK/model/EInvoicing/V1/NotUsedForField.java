...
public class NotUsedForField {
  ...
  public NotUsedForField() {
  }

  public NotUsedForField countryMandate(String countryMandate) {
  ...
  public boolean equals(Object o) {
    ...
    NotUsedForField notUsedForField = (NotUsedForField) o;
    return Objects.equals(this.countryMandate, notUsedForField.countryMandate);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotUsedForField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotUsedForField is not found in the empty JSON string", NotUsedForField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotUsedForField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotUsedForField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotUsedForField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotUsedForField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotUsedForField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotUsedForField.class));

       return (TypeAdapter<T>) new TypeAdapter<NotUsedForField>() {
           @Override
           public void write(JsonWriter out, NotUsedForField value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotUsedForField read(JsonReader in) throws IOException {

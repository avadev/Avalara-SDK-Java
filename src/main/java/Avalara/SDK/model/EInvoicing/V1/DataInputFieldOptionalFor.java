...
public class DataInputFieldOptionalFor {
  ...
  public DataInputFieldOptionalFor() {
  }

  public DataInputFieldOptionalFor countryMandate(String countryMandate) {
  ...
  public boolean equals(Object o) {
    ...
    DataInputFieldOptionalFor dataInputFieldOptionalFor = (DataInputFieldOptionalFor) o;
    return Objects.equals(this.countryMandate, dataInputFieldOptionalFor.countryMandate);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataInputFieldOptionalFor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataInputFieldOptionalFor is not found in the empty JSON string", DataInputFieldOptionalFor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataInputFieldOptionalFor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataInputFieldOptionalFor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataInputFieldOptionalFor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataInputFieldOptionalFor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataInputFieldOptionalFor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataInputFieldOptionalFor.class));

       return (TypeAdapter<T>) new TypeAdapter<DataInputFieldOptionalFor>() {
           @Override
           public void write(JsonWriter out, DataInputFieldOptionalFor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataInputFieldOptionalFor read(JsonReader in) throws IOException {

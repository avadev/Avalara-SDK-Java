...
public class Create1099Form201Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Create1099Form201Response.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Create1099Form201Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Create1099Form201Response' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Create1099Form201Response>() {
                @Override
                public void write(JsonWriter out, Create1099Form201Response value) throws IOException {
                ...
                @Override
                public Create1099Form201Response read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        Create1099Form201Response ret = new Create1099Form201Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for Create1099Form201Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return Create1099Form201Response.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Create1099Form201Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for Create1099Form201Response with oneOf schemas: Form1042SListItemResponse, Form1095BListItemResponse, Form1099BaseResponse, Form1099DivListItemResponse, Form1099IntListItemResponse, Form1099KListItemResponse, Form1099MiscListItemResponse, Form1099NecListItemResponse, Form1099RListItemResponse. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
     ...
     * @return An instance of Create1099Form201Response
     * @throws IOException if the JSON string is invalid with respect to Create1099Form201Response
     */
    public static Create1099Form201Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Create1099Form201Response.class);
    }

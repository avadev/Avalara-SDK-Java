...
public class Form1099K {
  ...
  public Form1099K businessName(String businessName) {
  ...
  public Form1099K businessName2(String businessName2) {
  ...
  public Form1099K firstName(String firstName) {
  ...
  public Form1099K middleName(String middleName) {
  ...
  public Form1099K lastName(String lastName) {
  ...
  public Form1099K suffixName(String suffixName) {
   ...
   * @return the Form1099K instance itself
   */
  public Form1099K putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filerType, form1099K.filerType) &&
        ...
        Objects.equals(this.businessName, form1099K.businessName) &&
        Objects.equals(this.businessName2, form1099K.businessName2) &&
        Objects.equals(this.firstName, form1099K.firstName) &&
        Objects.equals(this.middleName, form1099K.middleName) &&
        Objects.equals(this.lastName, form1099K.lastName) &&
        Objects.equals(this.suffixName, form1099K.suffixName) &&
        ...
        Objects.equals(this.additionalProperties, form1099K.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("filerType");
    openapiRequiredFields.add("paymentType");
    openapiRequiredFields.add("grossAmountPaymentCard");
    openapiRequiredFields.add("paymentTransactionNumber");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `filerType`
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Form1099K>() {
           ...
           public Form1099K read(JsonReader in) throws IOException {
             ...
             Form1099K instance = thisAdapter.fromJsonTree(jsonObj);

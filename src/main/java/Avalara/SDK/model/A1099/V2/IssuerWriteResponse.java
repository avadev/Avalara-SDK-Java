...
public class IssuerWriteResponse {
  ...
  public IssuerWriteResponse businessName2(String businessName2) {
  ...
  @Deprecated
  public IssuerWriteResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  @Deprecated
  public IssuerWriteResponse dbaName(String dbaName) {
  ...
  public IssuerWriteResponse tinType(TinTypeEnum tinType) {
  ...
  public IssuerWriteResponse firstName(String firstName) {
  ...
  public IssuerWriteResponse middleName(String middleName) {
  ...
  public IssuerWriteResponse lastName(String lastName) {
  ...
  public IssuerWriteResponse suffix(String suffix) {
    this.suffix = suffix;
    return this;
  }
  ...
  public IssuerWriteResponse tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public IssuerWriteResponse referenceId(String referenceId) {
  ...
  public IssuerWriteResponse telephone(String telephone) {
  ...
  public IssuerWriteResponse taxYear(Integer taxYear) {
  ...
  public IssuerWriteResponse countryCode(String countryCode) {
  ...
  public IssuerWriteResponse email(String email) {
    this.email = email;
    return this;
  }
  ...
  public IssuerWriteResponse address(String address) {
  ...
  public IssuerWriteResponse city(String city) {
    this.city = city;
    return this;
  }
  ...
  public IssuerWriteResponse state(String state) {
    this.state = state;
    return this;
  }
  ...
  public IssuerWriteResponse zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public IssuerWriteResponse foreignProvince(String foreignProvince) {
  ...
  public IssuerWriteResponse transferAgentName(String transferAgentName) {
  ...
  public IssuerWriteResponse lastFiling(Boolean lastFiling) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.validationErrors, issuerWriteResponse.validationErrors) &&
        ...
        Objects.equals(this.tinType, issuerWriteResponse.tinType) &&
        Objects.equals(this.firstName, issuerWriteResponse.firstName) &&
        Objects.equals(this.middleName, issuerWriteResponse.middleName) &&
        Objects.equals(this.lastName, issuerWriteResponse.lastName) &&
        Objects.equals(this.suffix, issuerWriteResponse.suffix) &&
        Objects.equals(this.tin, issuerWriteResponse.tin) &&
        Objects.equals(this.referenceId, issuerWriteResponse.referenceId) &&
        Objects.equals(this.telephone, issuerWriteResponse.telephone) &&
        Objects.equals(this.taxYear, issuerWriteResponse.taxYear) &&
        Objects.equals(this.countryCode, issuerWriteResponse.countryCode) &&
        Objects.equals(this.email, issuerWriteResponse.email) &&
        Objects.equals(this.address, issuerWriteResponse.address) &&
        Objects.equals(this.city, issuerWriteResponse.city) &&
        Objects.equals(this.state, issuerWriteResponse.state) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuerWriteResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuerWriteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssuerWriteResponse is not found in the empty JSON string", IssuerWriteResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuerWriteResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssuerWriteResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssuerWriteResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssuerWriteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssuerWriteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssuerWriteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssuerWriteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IssuerWriteResponse>() {
           @Override
           public void write(JsonWriter out, IssuerWriteResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssuerWriteResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssuerWriteResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssuerWriteResponse
   * @throws IOException if the JSON string is invalid with respect to IssuerWriteResponse
   */
  public static IssuerWriteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssuerWriteResponse.class);
  }

  /**
   * Convert an instance of IssuerWriteResponse to an JSON string
   *
   * @return JSON string
   */

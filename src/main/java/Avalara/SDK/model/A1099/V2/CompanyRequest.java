...
public class CompanyRequest {
  ...
  public CompanyRequest dbaName(String dbaName) {
  ...
  public CompanyRequest address(String address) {
  ...
  public CompanyRequest zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public CompanyRequest telephone(String telephone) {
  ...
  public CompanyRequest tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public CompanyRequest referenceId(String referenceId) {
  ...
  public CompanyRequest doTinMatch(Boolean doTinMatch) {
  ...
  public CompanyRequest groupName(String groupName) {
  ...
  public CompanyRequest foreignProvince(String foreignProvince) {
  ...
  public CompanyRequest countryCode(String countryCode) {
  ...
  public CompanyRequest resendRequests(Boolean resendRequests) {
  ...
  public CompanyRequest resendIntervalDays(Integer resendIntervalDays) {
  ...
  public CompanyRequest maxReminderAttempts(Integer maxReminderAttempts) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, companyRequest.name) &&
        Objects.equals(this.dbaName, companyRequest.dbaName) &&
        Objects.equals(this.email, companyRequest.email) &&
        Objects.equals(this.address, companyRequest.address) &&
        Objects.equals(this.city, companyRequest.city) &&
        Objects.equals(this.state, companyRequest.state) &&
        Objects.equals(this.zip, companyRequest.zip) &&
        Objects.equals(this.telephone, companyRequest.telephone) &&
        Objects.equals(this.tin, companyRequest.tin) &&
        Objects.equals(this.referenceId, companyRequest.referenceId) &&
        Objects.equals(this.doTinMatch, companyRequest.doTinMatch) &&
        Objects.equals(this.groupName, companyRequest.groupName) &&
        Objects.equals(this.foreignProvince, companyRequest.foreignProvince) &&
        Objects.equals(this.countryCode, companyRequest.countryCode) &&
        Objects.equals(this.resendRequests, companyRequest.resendRequests) &&
        Objects.equals(this.resendIntervalDays, companyRequest.resendIntervalDays) &&
        Objects.equals(this.maxReminderAttempts, companyRequest.maxReminderAttempts);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyRequest is not found in the empty JSON string", CompanyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompanyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyRequest>() {
           @Override
           public void write(JsonWriter out, CompanyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompanyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompanyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompanyRequest
   * @throws IOException if the JSON string is invalid with respect to CompanyRequest
   */
  public static CompanyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyRequest.class);
  }

  /**
   * Convert an instance of CompanyRequest to an JSON string
   *
   * @return JSON string
   */

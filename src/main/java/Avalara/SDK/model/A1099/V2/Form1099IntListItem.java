...
public class Form1099IntListItem {
  ...
  public Form1099IntListItem interestIncome(Double interestIncome) {
  ...
  public Form1099IntListItem earlyWithdrawalPenalty(Double earlyWithdrawalPenalty) {
  ...
  public Form1099IntListItem usSavingsBondsInterest(Double usSavingsBondsInterest) {
  ...
  public Form1099IntListItem federalIncomeTaxWithheld(Double federalIncomeTaxWithheld) {
  ...
  public Form1099IntListItem investmentExpenses(Double investmentExpenses) {
  ...
  public Form1099IntListItem foreignTaxPaid(Double foreignTaxPaid) {
  ...
  public Form1099IntListItem foreignCountry(String foreignCountry) {
  ...
  public Form1099IntListItem taxExemptInterest(Double taxExemptInterest) {
  ...
  public Form1099IntListItem marketDiscount(Double marketDiscount) {
  ...
  public Form1099IntListItem bondPremium(Double bondPremium) {
  ...
  public Form1099IntListItem bondPremiumOnTaxExemptBond(Double bondPremiumOnTaxExemptBond) {
  ...
  public Form1099IntListItem taxExemptBondCusipNumber(String taxExemptBondCusipNumber) {
  ...
  public Form1099IntListItem issuerReferenceId(String issuerReferenceId) {
  ...
  public Form1099IntListItem issuerTin(String issuerTin) {
  ...
  public Form1099IntListItem taxYear(Integer taxYear) {
  ...
  public Form1099IntListItem issuerId(String issuerId) {
  ...
  public Form1099IntListItem referenceId(String referenceId) {
  ...
  public Form1099IntListItem recipientName(String recipientName) {
  ...
  public Form1099IntListItem tinType(TinTypeEnum tinType) {
  ...
  public Form1099IntListItem recipientSecondName(String recipientSecondName) {
  ...
  public Form1099IntListItem address(String address) {
  ...
  public Form1099IntListItem address2(String address2) {
  ...
  public Form1099IntListItem city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Form1099IntListItem state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Form1099IntListItem zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public Form1099IntListItem email(String email) {
    this.email = email;
    return this;
  }
  ...
  public Form1099IntListItem accountNumber(String accountNumber) {
  ...
  public Form1099IntListItem officeCode(String officeCode) {
  ...
  public Form1099IntListItem nonUsProvince(String nonUsProvince) {
  ...
  public Form1099IntListItem countryCode(String countryCode) {
  ...
  public Form1099IntListItem federalEFile(Boolean federalEFile) {
  ...
  public Form1099IntListItem postalMail(Boolean postalMail) {
  ...
  public Form1099IntListItem stateEFile(Boolean stateEFile) {
  ...
  public Form1099IntListItem tinMatch(Boolean tinMatch) {
  ...
  public Form1099IntListItem noTin(Boolean noTin) {
    this.noTin = noTin;
    return this;
  }
  ...
  public Form1099IntListItem secondTinNotice(Boolean secondTinNotice) {
  ...
  public Form1099IntListItem fatcaFilingRequirement(Boolean fatcaFilingRequirement) {
  ...
  public Form1099IntListItem addressVerification(Boolean addressVerification) {
  ...
  public Form1099IntListItem stateAndLocalWithholding(StateAndLocalWithholdingRequest stateAndLocalWithholding) {
  ...
  public boolean equals(Object o) {
    ...
    Form1099IntListItem form1099IntListItem = (Form1099IntListItem) o;
    return Objects.equals(this.interestIncome, form1099IntListItem.interestIncome) &&
        Objects.equals(this.earlyWithdrawalPenalty, form1099IntListItem.earlyWithdrawalPenalty) &&
        Objects.equals(this.usSavingsBondsInterest, form1099IntListItem.usSavingsBondsInterest) &&
        Objects.equals(this.federalIncomeTaxWithheld, form1099IntListItem.federalIncomeTaxWithheld) &&
        Objects.equals(this.investmentExpenses, form1099IntListItem.investmentExpenses) &&
        Objects.equals(this.foreignTaxPaid, form1099IntListItem.foreignTaxPaid) &&
        Objects.equals(this.foreignCountry, form1099IntListItem.foreignCountry) &&
        Objects.equals(this.taxExemptInterest, form1099IntListItem.taxExemptInterest) &&
        Objects.equals(this.specifiedPrivateActivityBondInterest, form1099IntListItem.specifiedPrivateActivityBondInterest) &&
        Objects.equals(this.marketDiscount, form1099IntListItem.marketDiscount) &&
        Objects.equals(this.bondPremium, form1099IntListItem.bondPremium) &&
        Objects.equals(this.bondPremiumOnTreasuryObligations, form1099IntListItem.bondPremiumOnTreasuryObligations) &&
        Objects.equals(this.bondPremiumOnTaxExemptBond, form1099IntListItem.bondPremiumOnTaxExemptBond) &&
        Objects.equals(this.taxExemptBondCusipNumber, form1099IntListItem.taxExemptBondCusipNumber) &&
        Objects.equals(this.issuerReferenceId, form1099IntListItem.issuerReferenceId) &&
        Objects.equals(this.issuerTin, form1099IntListItem.issuerTin) &&
        Objects.equals(this.taxYear, form1099IntListItem.taxYear) &&
        Objects.equals(this.issuerId, form1099IntListItem.issuerId) &&
        Objects.equals(this.referenceId, form1099IntListItem.referenceId) &&
        Objects.equals(this.recipientTin, form1099IntListItem.recipientTin) &&
        Objects.equals(this.recipientName, form1099IntListItem.recipientName) &&
        Objects.equals(this.tinType, form1099IntListItem.tinType) &&
        Objects.equals(this.recipientSecondName, form1099IntListItem.recipientSecondName) &&
        Objects.equals(this.address, form1099IntListItem.address) &&
        Objects.equals(this.address2, form1099IntListItem.address2) &&
        Objects.equals(this.city, form1099IntListItem.city) &&
        Objects.equals(this.state, form1099IntListItem.state) &&
        Objects.equals(this.zip, form1099IntListItem.zip) &&
        Objects.equals(this.email, form1099IntListItem.email) &&
        Objects.equals(this.accountNumber, form1099IntListItem.accountNumber) &&
        Objects.equals(this.officeCode, form1099IntListItem.officeCode) &&
        Objects.equals(this.nonUsProvince, form1099IntListItem.nonUsProvince) &&
        Objects.equals(this.countryCode, form1099IntListItem.countryCode) &&
        Objects.equals(this.federalEFile, form1099IntListItem.federalEFile) &&
        Objects.equals(this.postalMail, form1099IntListItem.postalMail) &&
        Objects.equals(this.stateEFile, form1099IntListItem.stateEFile) &&
        Objects.equals(this.tinMatch, form1099IntListItem.tinMatch) &&
        Objects.equals(this.noTin, form1099IntListItem.noTin) &&
        Objects.equals(this.secondTinNotice, form1099IntListItem.secondTinNotice) &&
        Objects.equals(this.fatcaFilingRequirement, form1099IntListItem.fatcaFilingRequirement) &&
        Objects.equals(this.addressVerification, form1099IntListItem.addressVerification) &&
        Objects.equals(this.stateAndLocalWithholding, form1099IntListItem.stateAndLocalWithholding);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Form1099IntListItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Form1099IntListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Form1099IntListItem is not found in the empty JSON string", Form1099IntListItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Form1099IntListItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Form1099IntListItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Form1099IntListItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Form1099IntListItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Form1099IntListItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Form1099IntListItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1099IntListItem.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1099IntListItem>() {
           @Override
           public void write(JsonWriter out, Form1099IntListItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Form1099IntListItem read(JsonReader in) throws IOException {
   ...
   * @return An instance of Form1099IntListItem
   * @throws IOException if the JSON string is invalid with respect to Form1099IntListItem
   */
  public static Form1099IntListItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Form1099IntListItem.class);
  }

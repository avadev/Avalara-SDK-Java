...
public class CompanyBase {
  ...
  public CompanyBase dbaName(String dbaName) {
  ...
  public CompanyBase email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CompanyBase address(String address) {
  ...
  public CompanyBase city(String city) {
    this.city = city;
    return this;
  }
  ...
  public CompanyBase state(String state) {
    this.state = state;
    return this;
  }
  ...
  public CompanyBase zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public CompanyBase telephone(String telephone) {
  ...
  public CompanyBase tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public CompanyBase referenceId(String referenceId) {
  ...
  public CompanyBase doTinMatch(Boolean doTinMatch) {
  ...
  public CompanyBase groupName(String groupName) {
  ...
  public CompanyBase foreignProvince(String foreignProvince) {
  ...
  public CompanyBase countryCode(String countryCode) {
  ...
  public CompanyBase resendRequests(Boolean resendRequests) {
  ...
  public CompanyBase resendIntervalDays(Integer resendIntervalDays) {
  ...
  public CompanyBase maxReminderAttempts(Integer maxReminderAttempts) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, companyBase.name) &&
        Objects.equals(this.dbaName, companyBase.dbaName) &&
        Objects.equals(this.email, companyBase.email) &&
        Objects.equals(this.address, companyBase.address) &&
        Objects.equals(this.city, companyBase.city) &&
        Objects.equals(this.state, companyBase.state) &&
        Objects.equals(this.zip, companyBase.zip) &&
        Objects.equals(this.telephone, companyBase.telephone) &&
        Objects.equals(this.tin, companyBase.tin) &&
        Objects.equals(this.referenceId, companyBase.referenceId) &&
        Objects.equals(this.doTinMatch, companyBase.doTinMatch) &&
        Objects.equals(this.groupName, companyBase.groupName) &&
        Objects.equals(this.foreignProvince, companyBase.foreignProvince) &&
        Objects.equals(this.countryCode, companyBase.countryCode) &&
        Objects.equals(this.resendRequests, companyBase.resendRequests) &&
        Objects.equals(this.resendIntervalDays, companyBase.resendIntervalDays) &&
        Objects.equals(this.maxReminderAttempts, companyBase.maxReminderAttempts);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanyBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompanyBase.openapiRequiredFields) {

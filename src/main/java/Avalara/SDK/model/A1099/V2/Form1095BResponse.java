...
public class Form1095BResponse {
  ...
  public Form1095BResponse employeeFirstName(String employeeFirstName) {
  ...
  public Form1095BResponse employeeMiddleName(String employeeMiddleName) {
  ...
  public Form1095BResponse employeeLastName(String employeeLastName) {
  ...
  public Form1095BResponse employeeNameSuffix(String employeeNameSuffix) {
  ...
  public Form1095BResponse employeeDateOfBirth(OffsetDateTime employeeDateOfBirth) {
  ...
  public Form1095BResponse originOfHealthCoverageCode(OriginOfHealthCoverageCodeEnum originOfHealthCoverageCode) {
  ...
  public Form1095BResponse coveredIndividuals(List<CoveredIndividualRequest> coveredIndividuals) {
    this.coveredIndividuals = coveredIndividuals;
    return this;
  }

  public Form1095BResponse addCoveredIndividualsItem(CoveredIndividualRequest coveredIndividualsItem) {
  ...
  public Form1095BResponse createdAt(OffsetDateTime createdAt) {
  ...
  public Form1095BResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  public Form1095BResponse stateAndLocalWithholding(StateAndLocalWithholdingResponse stateAndLocalWithholding) {
  ...
  public Form1095BResponse tinType(TinTypeEnum tinType) {
  ...
  public Form1095BResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Form1095BResponse issuerId(String issuerId) {
  ...
  public Form1095BResponse issuerReferenceId(String issuerReferenceId) {
  ...
  public Form1095BResponse issuerTin(String issuerTin) {
  ...
  public Form1095BResponse taxYear(Integer taxYear) {
  ...
  public Form1095BResponse referenceId(String referenceId) {
  ...
  public Form1095BResponse recipientName(String recipientName) {
  ...
  public Form1095BResponse recipientTin(String recipientTin) {
  ...
  public Form1095BResponse recipientSecondName(String recipientSecondName) {
  ...
  public Form1095BResponse address(String address) {
  ...
  public Form1095BResponse address2(String address2) {
  ...
  public Form1095BResponse city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Form1095BResponse state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Form1095BResponse zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public Form1095BResponse email(String email) {
    this.email = email;
    return this;
  }
  ...
  public Form1095BResponse accountNumber(String accountNumber) {
  ...
  public Form1095BResponse officeCode(String officeCode) {
  ...
  public Form1095BResponse nonUsProvince(String nonUsProvince) {
  ...
  public Form1095BResponse countryCode(String countryCode) {
  ...
  public Form1095BResponse federalEFile(Boolean federalEFile) {
  ...
  public Form1095BResponse postalMail(Boolean postalMail) {
  ...
  public Form1095BResponse stateEFile(Boolean stateEFile) {
  ...
  public Form1095BResponse tinMatch(Boolean tinMatch) {
  ...
  public Form1095BResponse noTin(Boolean noTin) {
    this.noTin = noTin;
    return this;
  }
  ...
  public Form1095BResponse secondTinNotice(Boolean secondTinNotice) {
  ...
  public Form1095BResponse addressVerification(Boolean addressVerification) {
  ...
  public Form1095BResponse federalEfileStatus(StatusDetail federalEfileStatus) {
  ...
  public Form1095BResponse eDeliveryStatus(StatusDetail eDeliveryStatus) {
  ...
  public Form1095BResponse stateEfileStatus(List<StateEfileStatusDetailResponse> stateEfileStatus) {
    this.stateEfileStatus = stateEfileStatus;
    return this;
  }

  public Form1095BResponse addStateEfileStatusItem(StateEfileStatusDetailResponse stateEfileStatusItem) {
  ...
  public Form1095BResponse postalMailStatus(StatusDetail postalMailStatus) {
  ...
  public Form1095BResponse tinMatchStatus(StatusDetail tinMatchStatus) {
  ...
  public Form1095BResponse addressVerificationStatus(StatusDetail addressVerificationStatus) {
  ...
  public Form1095BResponse validationErrors(List<ValidationErrorResponse> validationErrors) {
    this.validationErrors = validationErrors;
    return this;
  }

  public Form1095BResponse addValidationErrorsItem(ValidationErrorResponse validationErrorsItem) {
  ...
  public boolean equals(Object o) {
    ...
    Form1095BResponse form1095BResponse = (Form1095BResponse) o;
    return Objects.equals(this.employeeFirstName, form1095BResponse.employeeFirstName) &&
        Objects.equals(this.employeeMiddleName, form1095BResponse.employeeMiddleName) &&
        Objects.equals(this.employeeLastName, form1095BResponse.employeeLastName) &&
        Objects.equals(this.employeeNameSuffix, form1095BResponse.employeeNameSuffix) &&
        Objects.equals(this.employeeDateOfBirth, form1095BResponse.employeeDateOfBirth) &&
        Objects.equals(this.originOfHealthCoverageCode, form1095BResponse.originOfHealthCoverageCode) &&
        Objects.equals(this.coveredIndividuals, form1095BResponse.coveredIndividuals) &&
        Objects.equals(this.type, form1095BResponse.type) &&
        Objects.equals(this.createdAt, form1095BResponse.createdAt) &&
        Objects.equals(this.updatedAt, form1095BResponse.updatedAt) &&
        Objects.equals(this.stateAndLocalWithholding, form1095BResponse.stateAndLocalWithholding) &&
        Objects.equals(this.tinType, form1095BResponse.tinType) &&
        Objects.equals(this.id, form1095BResponse.id) &&
        Objects.equals(this.issuerId, form1095BResponse.issuerId) &&
        Objects.equals(this.issuerReferenceId, form1095BResponse.issuerReferenceId) &&
        Objects.equals(this.issuerTin, form1095BResponse.issuerTin) &&
        Objects.equals(this.taxYear, form1095BResponse.taxYear) &&
        Objects.equals(this.referenceId, form1095BResponse.referenceId) &&
        Objects.equals(this.recipientName, form1095BResponse.recipientName) &&
        Objects.equals(this.recipientTin, form1095BResponse.recipientTin) &&
        Objects.equals(this.recipientSecondName, form1095BResponse.recipientSecondName) &&
        Objects.equals(this.address, form1095BResponse.address) &&
        Objects.equals(this.address2, form1095BResponse.address2) &&
        Objects.equals(this.city, form1095BResponse.city) &&
        Objects.equals(this.state, form1095BResponse.state) &&
        Objects.equals(this.zip, form1095BResponse.zip) &&
        Objects.equals(this.email, form1095BResponse.email) &&
        Objects.equals(this.accountNumber, form1095BResponse.accountNumber) &&
        Objects.equals(this.officeCode, form1095BResponse.officeCode) &&
        Objects.equals(this.nonUsProvince, form1095BResponse.nonUsProvince) &&
        Objects.equals(this.countryCode, form1095BResponse.countryCode) &&
        Objects.equals(this.federalEFile, form1095BResponse.federalEFile) &&
        Objects.equals(this.postalMail, form1095BResponse.postalMail) &&
        Objects.equals(this.stateEFile, form1095BResponse.stateEFile) &&
        Objects.equals(this.tinMatch, form1095BResponse.tinMatch) &&
        Objects.equals(this.noTin, form1095BResponse.noTin) &&
        Objects.equals(this.secondTinNotice, form1095BResponse.secondTinNotice) &&
        Objects.equals(this.addressVerification, form1095BResponse.addressVerification) &&
        Objects.equals(this.federalEfileStatus, form1095BResponse.federalEfileStatus) &&
        Objects.equals(this.eDeliveryStatus, form1095BResponse.eDeliveryStatus) &&
        Objects.equals(this.stateEfileStatus, form1095BResponse.stateEfileStatus) &&
        Objects.equals(this.postalMailStatus, form1095BResponse.postalMailStatus) &&
        Objects.equals(this.tinMatchStatus, form1095BResponse.tinMatchStatus) &&
        Objects.equals(this.addressVerificationStatus, form1095BResponse.addressVerificationStatus) &&
        Objects.equals(this.validationErrors, form1095BResponse.validationErrors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Form1095BResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Form1095BResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Form1095BResponse is not found in the empty JSON string", Form1095BResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Form1095BResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Form1095BResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Form1095BResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Form1095BResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Form1095BResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1095BResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1095BResponse>() {
           @Override
           public void write(JsonWriter out, Form1095BResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Form1095BResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Form1095BResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Form1095BResponse
   * @throws IOException if the JSON string is invalid with respect to Form1095BResponse
   */
  public static Form1095BResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Form1095BResponse.class);
  }

  /**
   * Convert an instance of Form1095BResponse to an JSON string
   *
   * @return JSON string
   */

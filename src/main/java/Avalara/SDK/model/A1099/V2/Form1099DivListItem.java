...
public class Form1099DivListItem {
  ...
  public Form1099DivListItem totalOrdinaryDividends(Double totalOrdinaryDividends) {
  ...
  public Form1099DivListItem qualifiedDividends(Double qualifiedDividends) {
  ...
  public Form1099DivListItem totalCapitalGainDistributions(Double totalCapitalGainDistributions) {
  ...
  public Form1099DivListItem unrecapturedSection1250Gain(Double unrecapturedSection1250Gain) {
  ...
  public Form1099DivListItem section1202Gain(Double section1202Gain) {
  ...
  public Form1099DivListItem collectiblesGain(Double collectiblesGain) {
  ...
  public Form1099DivListItem section897OrdinaryDividends(Double section897OrdinaryDividends) {
  ...
  public Form1099DivListItem section897CapitalGain(Double section897CapitalGain) {
  ...
  public Form1099DivListItem nondividendDistributions(Double nondividendDistributions) {
  ...
  public Form1099DivListItem federalIncomeTaxWithheld(Double federalIncomeTaxWithheld) {
  ...
  public Form1099DivListItem section199ADividends(Double section199ADividends) {
  ...
  public Form1099DivListItem investmentExpenses(Double investmentExpenses) {
  ...
  public Form1099DivListItem foreignTaxPaid(Double foreignTaxPaid) {
  ...
  public Form1099DivListItem foreignCountryOrUSPossession(String foreignCountryOrUSPossession) {
  ...
  public Form1099DivListItem cashLiquidationDistributions(Double cashLiquidationDistributions) {
  ...
  public Form1099DivListItem noncashLiquidationDistributions(Double noncashLiquidationDistributions) {
  ...
  public Form1099DivListItem exemptInterestDividends(Double exemptInterestDividends) {
  ...
  public Form1099DivListItem specifiedPrivateActivityBondInterestDividends(Double specifiedPrivateActivityBondInterestDividends) {
  ...
  public Form1099DivListItem issuerTin(String issuerTin) {
  ...
  public Form1099DivListItem taxYear(Integer taxYear) {
  ...
  public Form1099DivListItem referenceId(String referenceId) {
  ...
  public Form1099DivListItem recipientTin(String recipientTin) {
  ...
  public Form1099DivListItem recipientName(String recipientName) {
  ...
  public Form1099DivListItem recipientSecondName(String recipientSecondName) {
  ...
  public Form1099DivListItem city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Form1099DivListItem state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Form1099DivListItem zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public Form1099DivListItem accountNumber(String accountNumber) {
  ...
  public Form1099DivListItem officeCode(String officeCode) {
  ...
  public Form1099DivListItem countryCode(String countryCode) {
  ...
  public Form1099DivListItem federalEFile(Boolean federalEFile) {
  ...
  public Form1099DivListItem postalMail(Boolean postalMail) {
  ...
  public Form1099DivListItem stateEFile(Boolean stateEFile) {
  ...
  public Form1099DivListItem tinMatch(Boolean tinMatch) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalOrdinaryDividends, form1099DivListItem.totalOrdinaryDividends) &&
        ...
        Objects.equals(this.section897CapitalGain, form1099DivListItem.section897CapitalGain) &&
        Objects.equals(this.nondividendDistributions, form1099DivListItem.nondividendDistributions) &&
        Objects.equals(this.federalIncomeTaxWithheld, form1099DivListItem.federalIncomeTaxWithheld) &&
        Objects.equals(this.section199ADividends, form1099DivListItem.section199ADividends) &&
        Objects.equals(this.investmentExpenses, form1099DivListItem.investmentExpenses) &&
        Objects.equals(this.foreignTaxPaid, form1099DivListItem.foreignTaxPaid) &&
        Objects.equals(this.foreignCountryOrUSPossession, form1099DivListItem.foreignCountryOrUSPossession) &&
        Objects.equals(this.cashLiquidationDistributions, form1099DivListItem.cashLiquidationDistributions) &&
        Objects.equals(this.noncashLiquidationDistributions, form1099DivListItem.noncashLiquidationDistributions) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to Form1099DivListItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Form1099DivListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Form1099DivListItem is not found in the empty JSON string", Form1099DivListItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Form1099DivListItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Form1099DivListItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Form1099DivListItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Form1099DivListItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Form1099DivListItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Form1099DivListItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1099DivListItem.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1099DivListItem>() {
           @Override
           public void write(JsonWriter out, Form1099DivListItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Form1099DivListItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Form1099DivListItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Form1099DivListItem
   * @throws IOException if the JSON string is invalid with respect to Form1099DivListItem
   */
  public static Form1099DivListItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Form1099DivListItem.class);
  }

  /**
   * Convert an instance of Form1099DivListItem to an JSON string
   *
   * @return JSON string
   */

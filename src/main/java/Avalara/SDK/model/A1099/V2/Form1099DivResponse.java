...
public class Form1099DivResponse {
  ...
  public Form1099DivResponse createdAt(OffsetDateTime createdAt) {
  ...
  public Form1099DivResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  public Form1099DivResponse tinType(TinTypeEnum tinType) {
  ...
  public Form1099DivResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Form1099DivResponse issuerId(String issuerId) {
  ...
  public Form1099DivResponse issuerReferenceId(String issuerReferenceId) {
  ...
  public Form1099DivResponse issuerTin(String issuerTin) {
  ...
  public Form1099DivResponse taxYear(Integer taxYear) {
  ...
  public Form1099DivResponse referenceId(String referenceId) {
  ...
  public Form1099DivResponse recipientName(String recipientName) {
  ...
  public Form1099DivResponse recipientTin(String recipientTin) {
  ...
  public Form1099DivResponse recipientSecondName(String recipientSecondName) {
  ...
  public Form1099DivResponse address(String address) {
  ...
  public Form1099DivResponse address2(String address2) {
  ...
  public Form1099DivResponse city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Form1099DivResponse state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Form1099DivResponse zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public Form1099DivResponse accountNumber(String accountNumber) {
  ...
  public Form1099DivResponse officeCode(String officeCode) {
  ...
  public Form1099DivResponse countryCode(String countryCode) {
  ...
  public Form1099DivResponse federalEFile(Boolean federalEFile) {
  ...
  public Form1099DivResponse postalMail(Boolean postalMail) {
  ...
  public Form1099DivResponse stateEFile(Boolean stateEFile) {
  ...
  public Form1099DivResponse tinMatch(Boolean tinMatch) {
  ...
  public Form1099DivResponse federalEfileStatus(StatusDetail federalEfileStatus) {
  ...
  public Form1099DivResponse stateEfileStatus(List<StateEfileStatusDetailResponse> stateEfileStatus) {
    this.stateEfileStatus = stateEfileStatus;
    return this;
  }

  public Form1099DivResponse addStateEfileStatusItem(StateEfileStatusDetailResponse stateEfileStatusItem) {
  ...
  public Form1099DivResponse postalMailStatus(StatusDetail postalMailStatus) {
  ...
  public Form1099DivResponse tinMatchStatus(StatusDetail tinMatchStatus) {
  ...
  public Form1099DivResponse addressVerificationStatus(StatusDetail addressVerificationStatus) {
  ...
  public Form1099DivResponse validationErrors(List<ValidationErrorResponse> validationErrors) {
    this.validationErrors = validationErrors;
    return this;
  }

  public Form1099DivResponse addValidationErrorsItem(ValidationErrorResponse validationErrorsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, form1099DivResponse.type) &&
        ...
        Objects.equals(this.issuerId, form1099DivResponse.issuerId) &&
        Objects.equals(this.issuerReferenceId, form1099DivResponse.issuerReferenceId) &&
        Objects.equals(this.issuerTin, form1099DivResponse.issuerTin) &&
        Objects.equals(this.taxYear, form1099DivResponse.taxYear) &&
        Objects.equals(this.referenceId, form1099DivResponse.referenceId) &&
        Objects.equals(this.recipientName, form1099DivResponse.recipientName) &&
        Objects.equals(this.recipientTin, form1099DivResponse.recipientTin) &&
        Objects.equals(this.recipientSecondName, form1099DivResponse.recipientSecondName) &&
        Objects.equals(this.address, form1099DivResponse.address) &&
        Objects.equals(this.address2, form1099DivResponse.address2) &&
        ...
        Objects.equals(this.addressVerificationStatus, form1099DivResponse.addressVerificationStatus) &&
        Objects.equals(this.validationErrors, form1099DivResponse.validationErrors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Form1099DivResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Form1099DivResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Form1099DivResponse is not found in the empty JSON string", Form1099DivResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Form1099DivResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Form1099DivResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Form1099DivResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Form1099DivResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Form1099DivResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1099DivResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1099DivResponse>() {
           @Override
           public void write(JsonWriter out, Form1099DivResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Form1099DivResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Form1099DivResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Form1099DivResponse
   * @throws IOException if the JSON string is invalid with respect to Form1099DivResponse
   */
  public static Form1099DivResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Form1099DivResponse.class);
  }

  /**
   * Convert an instance of Form1099DivResponse to an JSON string
   *
   * @return JSON string
   */

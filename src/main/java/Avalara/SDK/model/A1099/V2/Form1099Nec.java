...
public class Form1099Nec {
  ...
  public Form1099Nec businessName(String businessName) {
  ...
  public Form1099Nec businessName2(String businessName2) {
  ...
  public Form1099Nec firstName(String firstName) {
  ...
  public Form1099Nec middleName(String middleName) {
  ...
  public Form1099Nec lastName(String lastName) {
  ...
  public Form1099Nec suffixName(String suffixName) {
   ...
   * @return the Form1099Nec instance itself
   */
  public Form1099Nec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nonemployeeCompensation, form1099Nec.nonemployeeCompensation) &&
        ...
        Objects.equals(this.businessName, form1099Nec.businessName) &&
        Objects.equals(this.businessName2, form1099Nec.businessName2) &&
        Objects.equals(this.firstName, form1099Nec.firstName) &&
        Objects.equals(this.middleName, form1099Nec.middleName) &&
        Objects.equals(this.lastName, form1099Nec.lastName) &&
        Objects.equals(this.suffixName, form1099Nec.suffixName) &&
        ...
        Objects.equals(this.additionalProperties, form1099Nec.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nonemployeeCompensation, directSalesIndicator, excessGoldenParachutePayments, federalIncomeTaxWithheld, type, id, issuerId, issuerReferenceId, issuerTin, taxYear, referenceId, tin, recipientName, address, address2, city, state, zip, email, nonUsProvince, countryCode, federalEfileDate, postalMail, stateEfileDate, recipientEdeliveryDate, tinMatch, addressVerification, stateAndLocalWithholding, federalEfileStatus, stateEfileStatus, postalMailStatus, tinMatchStatus, addressVerificationStatus, eDeliveryStatus, validationErrors, createdAt, updatedAt, tinType, businessName, businessName2, firstName, middleName, lastName, suffixName, recipientSecondName, accountNumber, officeCode, noTin, secondTinNotice, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Form1099Nec>() {
           ...
           public Form1099Nec read(JsonReader in) throws IOException {
             ...
             Form1099Nec instance = thisAdapter.fromJsonTree(jsonObj);

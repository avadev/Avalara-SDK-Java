...
public class Form1099DivRequest {
  ...
  public Form1099DivRequest issuerReferenceId(String issuerReferenceId) {
  ...
  public Form1099DivRequest issuerTin(String issuerTin) {
  ...
  public Form1099DivRequest taxYear(Integer taxYear) {
  ...
  public Form1099DivRequest tinType(Integer tinType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalOrdinaryDividends, form1099DivRequest.totalOrdinaryDividends) &&
        ...
        Objects.equals(this.issuerReferenceId, form1099DivRequest.issuerReferenceId) &&
        Objects.equals(this.issuerTin, form1099DivRequest.issuerTin) &&
        Objects.equals(this.taxYear, form1099DivRequest.taxYear) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalOrdinaryDividends, qualifiedDividends, totalCapitalGainDistr, unrecapSec1250Gain, section1202Gain, collectiblesGain, section897OrdinaryDividends, section897CapitalGain, nondividendDistributions, federalIncomeTaxWithheld, section199ADividends, investmentExpenses, foreignTaxPaid, foreignCountryOrUSPossession, cashLiquidationDistributions, noncashLiquidationDistributions, exemptInterestDividends, specifiedPrivateActivityBondInterestDividends, fatcaFilingRequirement, stateAndLocalWithholding, type, issuerId, issuerReferenceId, issuerTin, taxYear, referenceId, recipientName, recipientTin, tinType, recipientSecondName, streetAddress, streetAddressLine2, city, state, zip, recipientEmail, accountNumber, officeCode, recipientNonUsProvince, countryCode, federalEFile, postalMail, stateEFile, tinMatch, addressVerification);
  }

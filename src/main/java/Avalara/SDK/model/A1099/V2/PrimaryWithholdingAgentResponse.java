...
public class PrimaryWithholdingAgentResponse {
  ...
  public PrimaryWithholdingAgentResponse() {
  }
  ...
  public boolean equals(Object o) {
    ...
    PrimaryWithholdingAgentResponse primaryWithholdingAgentResponse = (PrimaryWithholdingAgentResponse) o;
    return Objects.equals(this.primaryWithholdingAgentName, primaryWithholdingAgentResponse.primaryWithholdingAgentName) &&
        Objects.equals(this.primaryWithholdingAgentEin, primaryWithholdingAgentResponse.primaryWithholdingAgentEin);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrimaryWithholdingAgentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrimaryWithholdingAgentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryWithholdingAgentResponse is not found in the empty JSON string", PrimaryWithholdingAgentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrimaryWithholdingAgentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrimaryWithholdingAgentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryWithholdingAgentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryWithholdingAgentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryWithholdingAgentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryWithholdingAgentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryWithholdingAgentResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryWithholdingAgentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrimaryWithholdingAgentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrimaryWithholdingAgentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrimaryWithholdingAgentResponse
   * @throws IOException if the JSON string is invalid with respect to PrimaryWithholdingAgentResponse
   */
  public static PrimaryWithholdingAgentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryWithholdingAgentResponse.class);
  }

  /**
   * Convert an instance of PrimaryWithholdingAgentResponse to an JSON string
   *
   * @return JSON string
   */

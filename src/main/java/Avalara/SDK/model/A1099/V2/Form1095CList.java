...
public class Form1095CList {
  ...
  private List<Form1095CListItem> forms;
  ...
  public Form1095CList forms(List<Form1095CListItem> forms) {
    this.forms = forms;
    return this;
  }
  ...
  public List<Form1095CListItem> getForms() {
    return forms;
  }

  public void setForms(List<Form1095CListItem> forms) {
    this.forms = forms;
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Form1095CList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1095CList.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1095CList>() {
           @Override

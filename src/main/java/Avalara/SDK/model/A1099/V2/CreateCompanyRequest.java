...
public class CreateCompanyRequest extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CompanyCreateUpdateRequestModel> adapterCompanyCreateUpdateRequestModel = gson.getDelegateAdapter(this, TypeToken.get(CompanyCreateUpdateRequestModel.class));
            final TypeAdapter<CompanyResponse> adapterCompanyResponse = gson.getDelegateAdapter(this, TypeToken.get(CompanyResponse.class));

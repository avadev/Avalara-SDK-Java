...
public class Form1099NecListItem {
  ...
  public Form1099NecListItem directSalesIndicator(Boolean directSalesIndicator) {
  ...
  public Form1099NecListItem tinType(TinTypeEnum tinType) {
  ...
  public Form1099NecListItem address(String address) {
  ...
  public Form1099NecListItem address2(String address2) {
  ...
  public Form1099NecListItem email(String email) {
    this.email = email;
    return this;
  }
  ...
  public Form1099NecListItem nonUsProvince(String nonUsProvince) {
  ...
  public Form1099NecListItem noTin(Boolean noTin) {
    this.noTin = noTin;
    return this;
  }
  ...
  public Form1099NecListItem fatcaFilingRequirement(Boolean fatcaFilingRequirement) {
  ...
  public Form1099NecListItem stateAndLocalWithholding(StateAndLocalWithholdingRequest stateAndLocalWithholding) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nonemployeeCompensation, form1099NecListItem.nonemployeeCompensation) &&
        Objects.equals(this.directSalesIndicator, form1099NecListItem.directSalesIndicator) &&
        ...
        Objects.equals(this.address, form1099NecListItem.address) &&
        Objects.equals(this.address2, form1099NecListItem.address2) &&
        ...
        Objects.equals(this.email, form1099NecListItem.email) &&
        ...
        Objects.equals(this.nonUsProvince, form1099NecListItem.nonUsProvince) &&
        ...
        Objects.equals(this.noTin, form1099NecListItem.noTin) &&
        Objects.equals(this.secondTinNotice, form1099NecListItem.secondTinNotice) &&
        Objects.equals(this.fatcaFilingRequirement, form1099NecListItem.fatcaFilingRequirement) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nonemployeeCompensation, directSalesIndicator, federalIncomeTaxWithheld, issuerReferenceId, issuerTin, taxYear, issuerId, referenceId, recipientTin, recipientName, tinType, recipientSecondName, address, address2, city, state, zip, email, accountNumber, officeCode, nonUsProvince, countryCode, federalEFile, postalMail, stateEFile, tinMatch, noTin, secondTinNotice, fatcaFilingRequirement, addressVerification, stateAndLocalWithholding);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Form1099NecListItem.openapiRequiredFields) {

...
public class Form1095BListItemResponse {
  ...
  private List<CoveredIndividualReferenceResponse> coveredIndividuals;
  ...
  public Form1095BListItemResponse originOfHealthCoverageCode(String originOfHealthCoverageCode) {
  ...
  public Form1095BListItemResponse coveredIndividuals(List<CoveredIndividualReferenceResponse> coveredIndividuals) {
    this.coveredIndividuals = coveredIndividuals;
    return this;
  }

  public Form1095BListItemResponse addCoveredIndividualsItem(CoveredIndividualReferenceResponse coveredIndividualsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CoveredIndividualReferenceResponse> getCoveredIndividuals() {
    return coveredIndividuals;
  }

  public void setCoveredIndividuals(List<CoveredIndividualReferenceResponse> coveredIndividuals) {
    this.coveredIndividuals = coveredIndividuals;
  }
  ...
  public Form1095BListItemResponse type(String type) {
    this.type = type;
    return this;
  }
  ...
  public Form1095BListItemResponse issuerId(Integer issuerId) {
  ...
  public Form1095BListItemResponse issuerReferenceId(String issuerReferenceId) {
  ...
  public Form1095BListItemResponse issuerTin(String issuerTin) {
  ...
  public Form1095BListItemResponse taxYear(Integer taxYear) {
  ...
  public Form1095BListItemResponse federalEfile(Boolean federalEfile) {
  ...
  public Form1095BListItemResponse stateEfile(Boolean stateEfile) {
  ...
  public Form1095BListItemResponse postalMail(Boolean postalMail) {
  ...
  public Form1095BListItemResponse tinMatch(Boolean tinMatch) {
  ...
  public Form1095BListItemResponse addressVerification(Boolean addressVerification) {
  ...
  public Form1095BListItemResponse email(String email) {
    this.email = email;
    return this;
  }
  ...
  public Form1095BListItemResponse tinType(String tinType) {
  ...
  public Form1095BListItemResponse tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public Form1095BListItemResponse recipientSecondName(String recipientSecondName) {
  ...
  public Form1095BListItemResponse address(String address) {
  ...
  public Form1095BListItemResponse address2(String address2) {
  ...
  public Form1095BListItemResponse city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Form1095BListItemResponse state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Form1095BListItemResponse zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public Form1095BListItemResponse countryCode(String countryCode) {
  ...
  public Form1095BListItemResponse stateAndLocalWithholding(StateAndLocalWithholdingResponse stateAndLocalWithholding) {
  ...
  public boolean equals(Object o) {
    ...
    Form1095BListItemResponse form1095BListItemResponse = (Form1095BListItemResponse) o;
    return Objects.equals(this.originOfHealthCoverageCode, form1095BListItemResponse.originOfHealthCoverageCode) &&
        Objects.equals(this.coveredIndividuals, form1095BListItemResponse.coveredIndividuals) &&
        Objects.equals(this.id, form1095BListItemResponse.id) &&
        Objects.equals(this.type, form1095BListItemResponse.type) &&
        Objects.equals(this.issuerId, form1095BListItemResponse.issuerId) &&
        Objects.equals(this.issuerReferenceId, form1095BListItemResponse.issuerReferenceId) &&
        Objects.equals(this.issuerTin, form1095BListItemResponse.issuerTin) &&
        Objects.equals(this.taxYear, form1095BListItemResponse.taxYear) &&
        Objects.equals(this.federalEfile, form1095BListItemResponse.federalEfile) &&
        Objects.equals(this.federalEfileStatus, form1095BListItemResponse.federalEfileStatus) &&
        Objects.equals(this.stateEfile, form1095BListItemResponse.stateEfile) &&
        Objects.equals(this.stateEfileStatus, form1095BListItemResponse.stateEfileStatus) &&
        Objects.equals(this.postalMail, form1095BListItemResponse.postalMail) &&
        Objects.equals(this.postalMailStatus, form1095BListItemResponse.postalMailStatus) &&
        Objects.equals(this.tinMatch, form1095BListItemResponse.tinMatch) &&
        ...
        Objects.equals(this.address2, form1095BListItemResponse.address2) &&
        ...
        Objects.equals(this.stateAndLocalWithholding, form1095BListItemResponse.stateAndLocalWithholding);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Form1095BListItemResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Form1095BListItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Form1095BListItemResponse is not found in the empty JSON string", Form1095BListItemResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Form1095BListItemResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Form1095BListItemResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Form1095BListItemResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("coveredIndividuals") != null && !jsonObj.get("coveredIndividuals").isJsonNull()) {
        ...
        if (jsonArraycoveredIndividuals != null) {
          ...
          for (int i = 0; i < jsonArraycoveredIndividuals.size(); i++) {
            CoveredIndividualReferenceResponse.validateJsonElement(jsonArraycoveredIndividuals.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Form1095BListItemResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Form1095BListItemResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Form1095BListItemResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1095BListItemResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1095BListItemResponse>() {
           @Override
           public void write(JsonWriter out, Form1095BListItemResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Form1095BListItemResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Form1095BListItemResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Form1095BListItemResponse
   * @throws IOException if the JSON string is invalid with respect to Form1095BListItemResponse
   */
  public static Form1095BListItemResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Form1095BListItemResponse.class);
  }

  /**
   * Convert an instance of Form1095BListItemResponse to an JSON string
   *
   * @return JSON string
   */

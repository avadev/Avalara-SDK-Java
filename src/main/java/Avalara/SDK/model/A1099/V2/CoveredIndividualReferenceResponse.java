...
public class CoveredIndividualReferenceResponse {
  ...
  public CoveredIndividualReferenceResponse() {
  }

  public CoveredIndividualReferenceResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CoveredIndividualReferenceResponse firstName(String firstName) {
  ...
  public CoveredIndividualReferenceResponse middleName(String middleName) {
  ...
  public CoveredIndividualReferenceResponse lastName(String lastName) {
  ...
  public CoveredIndividualReferenceResponse nameSuffix(String nameSuffix) {
  ...
  public CoveredIndividualReferenceResponse tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public CoveredIndividualReferenceResponse birthDate(OffsetDateTime birthDate) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth0(Boolean coveredMonth0) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth1(Boolean coveredMonth1) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth2(Boolean coveredMonth2) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth3(Boolean coveredMonth3) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth4(Boolean coveredMonth4) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth5(Boolean coveredMonth5) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth6(Boolean coveredMonth6) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth7(Boolean coveredMonth7) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth8(Boolean coveredMonth8) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth9(Boolean coveredMonth9) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth10(Boolean coveredMonth10) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth11(Boolean coveredMonth11) {
  ...
  public CoveredIndividualReferenceResponse coveredMonth12(Boolean coveredMonth12) {
  ...
  public boolean equals(Object o) {
    ...
    CoveredIndividualReferenceResponse coveredIndividualReferenceResponse = (CoveredIndividualReferenceResponse) o;
    return Objects.equals(this.id, coveredIndividualReferenceResponse.id) &&
        Objects.equals(this.firstName, coveredIndividualReferenceResponse.firstName) &&
        Objects.equals(this.middleName, coveredIndividualReferenceResponse.middleName) &&
        Objects.equals(this.lastName, coveredIndividualReferenceResponse.lastName) &&
        Objects.equals(this.nameSuffix, coveredIndividualReferenceResponse.nameSuffix) &&
        Objects.equals(this.tin, coveredIndividualReferenceResponse.tin) &&
        Objects.equals(this.birthDate, coveredIndividualReferenceResponse.birthDate) &&
        Objects.equals(this.coveredMonth0, coveredIndividualReferenceResponse.coveredMonth0) &&
        Objects.equals(this.coveredMonth1, coveredIndividualReferenceResponse.coveredMonth1) &&
        Objects.equals(this.coveredMonth2, coveredIndividualReferenceResponse.coveredMonth2) &&
        Objects.equals(this.coveredMonth3, coveredIndividualReferenceResponse.coveredMonth3) &&
        Objects.equals(this.coveredMonth4, coveredIndividualReferenceResponse.coveredMonth4) &&
        Objects.equals(this.coveredMonth5, coveredIndividualReferenceResponse.coveredMonth5) &&
        Objects.equals(this.coveredMonth6, coveredIndividualReferenceResponse.coveredMonth6) &&
        Objects.equals(this.coveredMonth7, coveredIndividualReferenceResponse.coveredMonth7) &&
        Objects.equals(this.coveredMonth8, coveredIndividualReferenceResponse.coveredMonth8) &&
        Objects.equals(this.coveredMonth9, coveredIndividualReferenceResponse.coveredMonth9) &&
        Objects.equals(this.coveredMonth10, coveredIndividualReferenceResponse.coveredMonth10) &&
        Objects.equals(this.coveredMonth11, coveredIndividualReferenceResponse.coveredMonth11) &&
        Objects.equals(this.coveredMonth12, coveredIndividualReferenceResponse.coveredMonth12);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, middleName, lastName, nameSuffix, tin, birthDate, coveredMonth0, coveredMonth1, coveredMonth2, coveredMonth3, coveredMonth4, coveredMonth5, coveredMonth6, coveredMonth7, coveredMonth8, coveredMonth9, coveredMonth10, coveredMonth11, coveredMonth12);
  }
  ...
  static {
    ...
    openapiFields.add("coveredMonth0");
    openapiFields.add("coveredMonth1");
    openapiFields.add("coveredMonth2");
    openapiFields.add("coveredMonth3");
    openapiFields.add("coveredMonth4");
    openapiFields.add("coveredMonth5");
    openapiFields.add("coveredMonth6");
    openapiFields.add("coveredMonth7");
    openapiFields.add("coveredMonth8");
    openapiFields.add("coveredMonth9");
    openapiFields.add("coveredMonth10");
    openapiFields.add("coveredMonth11");
    openapiFields.add("coveredMonth12");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CoveredIndividualReferenceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoveredIndividualReferenceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoveredIndividualReferenceResponse is not found in the empty JSON string", CoveredIndividualReferenceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoveredIndividualReferenceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoveredIndividualReferenceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoveredIndividualReferenceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoveredIndividualReferenceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoveredIndividualReferenceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoveredIndividualReferenceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CoveredIndividualReferenceResponse>() {
           @Override
           public void write(JsonWriter out, CoveredIndividualReferenceResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoveredIndividualReferenceResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CoveredIndividualReferenceResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CoveredIndividualReferenceResponse
   * @throws IOException if the JSON string is invalid with respect to CoveredIndividualReferenceResponse
   */
  public static CoveredIndividualReferenceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoveredIndividualReferenceResponse.class);
  }

  /**
   * Convert an instance of CoveredIndividualReferenceResponse to an JSON string
   *
   * @return JSON string
   */

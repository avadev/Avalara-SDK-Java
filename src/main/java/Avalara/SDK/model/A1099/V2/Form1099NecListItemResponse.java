...
public class Form1099NecListItemResponse {
  ...
  public Form1099NecListItemResponse() {
  }
  ...
  public Form1099NecListItemResponse nonemployeeCompensation(Double nonemployeeCompensation) {
  ...
  public Form1099NecListItemResponse federalIncomeTaxWithheld(Double federalIncomeTaxWithheld) {
  ...
  public Form1099NecListItemResponse directSalesIndicator(Boolean directSalesIndicator) {
  ...
  public Form1099NecListItemResponse type(String type) {
    this.type = type;
    return this;
  }
  ...
  public Form1099NecListItemResponse issuerId(Integer issuerId) {
  ...
  public Form1099NecListItemResponse issuerReferenceId(String issuerReferenceId) {
  ...
  public Form1099NecListItemResponse issuerTin(String issuerTin) {
  ...
  public Form1099NecListItemResponse taxYear(Integer taxYear) {
  ...
  public Form1099NecListItemResponse federalEfile(Boolean federalEfile) {
  ...
  public Form1099NecListItemResponse stateEfile(Boolean stateEfile) {
  ...
  public Form1099NecListItemResponse postalMail(Boolean postalMail) {
  ...
  public Form1099NecListItemResponse tinMatch(Boolean tinMatch) {
  ...
  public Form1099NecListItemResponse addressVerification(Boolean addressVerification) {
  ...
  public Form1099NecListItemResponse referenceId(String referenceId) {
  ...
  public Form1099NecListItemResponse email(String email) {
    this.email = email;
    return this;
  }
  ...
  public Form1099NecListItemResponse tinType(String tinType) {
  ...
  public Form1099NecListItemResponse tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public Form1099NecListItemResponse noTin(Boolean noTin) {
    this.noTin = noTin;
    return this;
  }
  ...
  public Form1099NecListItemResponse secondTinNotice(Boolean secondTinNotice) {
  ...
  public Form1099NecListItemResponse recipientName(String recipientName) {
  ...
  public Form1099NecListItemResponse recipientSecondName(String recipientSecondName) {
  ...
  public Form1099NecListItemResponse address(String address) {
  ...
  public Form1099NecListItemResponse address2(String address2) {
  ...
  public Form1099NecListItemResponse city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Form1099NecListItemResponse state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Form1099NecListItemResponse zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public Form1099NecListItemResponse nonUsProvince(String nonUsProvince) {
  ...
  public Form1099NecListItemResponse countryCode(String countryCode) {
  ...
  public Form1099NecListItemResponse accountNumber(String accountNumber) {
  ...
  public Form1099NecListItemResponse officeCode(String officeCode) {
  ...
  public Form1099NecListItemResponse fatcaFilingRequirement(Boolean fatcaFilingRequirement) {
  ...
  public Form1099NecListItemResponse stateAndLocalWithholding(StateAndLocalWithholdingResponse stateAndLocalWithholding) {
  ...
  public boolean equals(Object o) {
    ...
    Form1099NecListItemResponse form1099NecListItemResponse = (Form1099NecListItemResponse) o;
    return Objects.equals(this.nonemployeeCompensation, form1099NecListItemResponse.nonemployeeCompensation) &&
        Objects.equals(this.federalIncomeTaxWithheld, form1099NecListItemResponse.federalIncomeTaxWithheld) &&
        Objects.equals(this.directSalesIndicator, form1099NecListItemResponse.directSalesIndicator) &&
        Objects.equals(this.id, form1099NecListItemResponse.id) &&
        Objects.equals(this.type, form1099NecListItemResponse.type) &&
        Objects.equals(this.issuerId, form1099NecListItemResponse.issuerId) &&
        Objects.equals(this.issuerReferenceId, form1099NecListItemResponse.issuerReferenceId) &&
        Objects.equals(this.issuerTin, form1099NecListItemResponse.issuerTin) &&
        Objects.equals(this.taxYear, form1099NecListItemResponse.taxYear) &&
        Objects.equals(this.federalEfile, form1099NecListItemResponse.federalEfile) &&
        Objects.equals(this.federalEfileStatus, form1099NecListItemResponse.federalEfileStatus) &&
        Objects.equals(this.stateEfile, form1099NecListItemResponse.stateEfile) &&
        Objects.equals(this.stateEfileStatus, form1099NecListItemResponse.stateEfileStatus) &&
        Objects.equals(this.postalMail, form1099NecListItemResponse.postalMail) &&
        Objects.equals(this.postalMailStatus, form1099NecListItemResponse.postalMailStatus) &&
        Objects.equals(this.tinMatch, form1099NecListItemResponse.tinMatch) &&
        Objects.equals(this.tinMatchStatus, form1099NecListItemResponse.tinMatchStatus) &&
        Objects.equals(this.addressVerification, form1099NecListItemResponse.addressVerification) &&
        Objects.equals(this.addressVerificationStatus, form1099NecListItemResponse.addressVerificationStatus) &&
        Objects.equals(this.eDeliveryStatus, form1099NecListItemResponse.eDeliveryStatus) &&
        Objects.equals(this.referenceId, form1099NecListItemResponse.referenceId) &&
        Objects.equals(this.email, form1099NecListItemResponse.email) &&
        Objects.equals(this.tinType, form1099NecListItemResponse.tinType) &&
        Objects.equals(this.tin, form1099NecListItemResponse.tin) &&
        Objects.equals(this.noTin, form1099NecListItemResponse.noTin) &&
        Objects.equals(this.secondTinNotice, form1099NecListItemResponse.secondTinNotice) &&
        Objects.equals(this.recipientName, form1099NecListItemResponse.recipientName) &&
        Objects.equals(this.recipientSecondName, form1099NecListItemResponse.recipientSecondName) &&
        Objects.equals(this.address, form1099NecListItemResponse.address) &&
        Objects.equals(this.address2, form1099NecListItemResponse.address2) &&
        Objects.equals(this.city, form1099NecListItemResponse.city) &&
        Objects.equals(this.state, form1099NecListItemResponse.state) &&
        Objects.equals(this.zip, form1099NecListItemResponse.zip) &&
        Objects.equals(this.nonUsProvince, form1099NecListItemResponse.nonUsProvince) &&
        Objects.equals(this.countryCode, form1099NecListItemResponse.countryCode) &&
        Objects.equals(this.accountNumber, form1099NecListItemResponse.accountNumber) &&
        Objects.equals(this.officeCode, form1099NecListItemResponse.officeCode) &&
        Objects.equals(this.fatcaFilingRequirement, form1099NecListItemResponse.fatcaFilingRequirement) &&
        Objects.equals(this.validationErrors, form1099NecListItemResponse.validationErrors) &&
        Objects.equals(this.createdAt, form1099NecListItemResponse.createdAt) &&
        Objects.equals(this.updatedAt, form1099NecListItemResponse.updatedAt) &&
        Objects.equals(this.stateAndLocalWithholding, form1099NecListItemResponse.stateAndLocalWithholding);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Form1099NecListItemResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Form1099NecListItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Form1099NecListItemResponse is not found in the empty JSON string", Form1099NecListItemResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Form1099NecListItemResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Form1099NecListItemResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Form1099NecListItemResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Form1099NecListItemResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Form1099NecListItemResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Form1099NecListItemResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Form1099NecListItemResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Form1099NecListItemResponse>() {
           @Override
           public void write(JsonWriter out, Form1099NecListItemResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Form1099NecListItemResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Form1099NecListItemResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Form1099NecListItemResponse
   * @throws IOException if the JSON string is invalid with respect to Form1099NecListItemResponse
   */
  public static Form1099NecListItemResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Form1099NecListItemResponse.class);
  }

  /**
   * Convert an instance of Form1099NecListItemResponse to an JSON string
   *
   * @return JSON string
   */

...
public class Form1099Base {
  ...
  public Form1099Base type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Form1099Base issuerId(String issuerId) {
  ...
  public Form1099Base tinType(TinTypeEnum tinType) {
  ...
  public Form1099Base federalEfileDate(LocalDate federalEfileDate) {
  ...
  public Form1099Base stateEfileDate(LocalDate stateEfileDate) {
  ...
  public Form1099Base recipientEdeliveryDate(LocalDate recipientEdeliveryDate) {
   ...
   * @return the Form1099Base instance itself
   */
  public Form1099Base putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, form1099Base.type) &&
        Objects.equals(this.id, form1099Base.id) &&
        ...
        Objects.equals(this.federalEfileDate, form1099Base.federalEfileDate) &&
        Objects.equals(this.postalMail, form1099Base.postalMail) &&
        Objects.equals(this.stateEfileDate, form1099Base.stateEfileDate) &&
        Objects.equals(this.recipientEdeliveryDate, form1099Base.recipientEdeliveryDate) &&
        ...
        Objects.equals(this.additionalProperties, form1099Base.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, id, issuerId, issuerReferenceId, issuerTin, taxYear, referenceId, tin, recipientName, tinType, recipientSecondName, address, address2, city, state, zip, email, accountNumber, officeCode, nonUsProvince, countryCode, federalEfileDate, postalMail, stateEfileDate, recipientEdeliveryDate, tinMatch, noTin, addressVerification, stateAndLocalWithholding, secondTinNotice, federalEfileStatus, stateEfileStatus, postalMailStatus, tinMatchStatus, addressVerificationStatus, eDeliveryStatus, validationErrors, createdAt, updatedAt, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Form1099Base.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Form1099Base>() {
           ...
           public Form1099Base read(JsonReader in) throws IOException {
             ...
             Form1099Base instance = thisAdapter.fromJsonTree(jsonObj);

...
public class IssuerRequest {
  ...
  public IssuerRequest businessName(String businessName) {
  ...
  public IssuerRequest businessName2(String businessName2) {
  ...
  @Deprecated
  public IssuerRequest dbaName(String dbaName) {
  ...
  public IssuerRequest tinType(TinTypeEnum tinType) {
  ...
  public IssuerRequest firstName(String firstName) {
  ...
  public IssuerRequest middleName(String middleName) {
  ...
  public IssuerRequest lastName(String lastName) {
  ...
  public IssuerRequest suffix(String suffix) {
    this.suffix = suffix;
    return this;
  }
  ...
  public IssuerRequest tin(String tin) {
    this.tin = tin;
    return this;
  }
  ...
  public IssuerRequest referenceId(String referenceId) {
  ...
  public IssuerRequest telephone(String telephone) {
  ...
  public IssuerRequest taxYear(Integer taxYear) {
  ...
  public IssuerRequest countryCode(String countryCode) {
  ...
  public IssuerRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public IssuerRequest address(String address) {
  ...
  public IssuerRequest state(String state) {
    this.state = state;
    return this;
  }
  ...
  public IssuerRequest zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public IssuerRequest foreignProvince(String foreignProvince) {
  ...
  public IssuerRequest transferAgentName(String transferAgentName) {
  ...
  public IssuerRequest lastFiling(Boolean lastFiling) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.businessName, issuerRequest.businessName) &&
        Objects.equals(this.businessName2, issuerRequest.businessName2) &&
        Objects.equals(this.name, issuerRequest.name) &&
        Objects.equals(this.dbaName, issuerRequest.dbaName) &&
        Objects.equals(this.tinType, issuerRequest.tinType) &&
        Objects.equals(this.firstName, issuerRequest.firstName) &&
        Objects.equals(this.middleName, issuerRequest.middleName) &&
        Objects.equals(this.lastName, issuerRequest.lastName) &&
        Objects.equals(this.suffix, issuerRequest.suffix) &&
        Objects.equals(this.tin, issuerRequest.tin) &&
        Objects.equals(this.referenceId, issuerRequest.referenceId) &&
        Objects.equals(this.telephone, issuerRequest.telephone) &&
        Objects.equals(this.taxYear, issuerRequest.taxYear) &&
        Objects.equals(this.countryCode, issuerRequest.countryCode) &&
        Objects.equals(this.email, issuerRequest.email) &&
        Objects.equals(this.address, issuerRequest.address) &&
        Objects.equals(this.city, issuerRequest.city) &&
        Objects.equals(this.state, issuerRequest.state) &&
        Objects.equals(this.zip, issuerRequest.zip) &&
        Objects.equals(this.foreignProvince, issuerRequest.foreignProvince) &&
        Objects.equals(this.transferAgentName, issuerRequest.transferAgentName) &&
        Objects.equals(this.lastFiling, issuerRequest.lastFiling);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssuerRequest is not found in the empty JSON string", IssuerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssuerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssuerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssuerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssuerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssuerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssuerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IssuerRequest>() {
           @Override
           public void write(JsonWriter out, IssuerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssuerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssuerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssuerRequest
   * @throws IOException if the JSON string is invalid with respect to IssuerRequest
   */
  public static IssuerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssuerRequest.class);
  }

  /**
   * Convert an instance of IssuerRequest to an JSON string
   *
   * @return JSON string
   */

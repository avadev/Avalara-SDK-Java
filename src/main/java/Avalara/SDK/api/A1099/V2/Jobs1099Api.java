...
public class Jobs1099Api {
    ...
    public JobResult getJob(GetJobRequest requestParameters) throws ApiException {
        ApiResponse<JobResult> localVarResp = getJobWithHttpInfo(requestParameters);
     ...
     */
    public ApiResponse<JobResult> getJobWithHttpInfo(GetJobRequest requestParameters) throws ApiException {
     ...
     */
    public okhttp3.Call getJobAsync(GetJobRequest requestParameters, final ApiCallback<JobResult> _callback) throws ApiException {

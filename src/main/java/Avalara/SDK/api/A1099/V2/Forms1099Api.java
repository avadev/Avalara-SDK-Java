...
public class Forms1099Api {
    ...
    private okhttp3.Call bulkUpsert1099FormsValidateBeforeCall(BulkUpsert1099FormsRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling bulkUpsert1099Forms(Async)");
        }
    ...
    */
    ...
    private okhttp3.Call create1099FormValidateBeforeCall(Create1099FormRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'requestParameters.xCorrelationId' is set
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling create1099Form(Async)");
        }
     ...
     */
    public FormResponseBase create1099Form(Create1099FormRequest requestParameters) throws ApiException {
        ApiResponse<FormResponseBase> localVarResp = create1099FormWithHttpInfo(requestParameters);
        return localVarResp.getData();
    }
     ...
     * 
     * @param requestOptions Object which represents the options available for a given API/request
     * @return ApiResponse&lt;FormResponseBase&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FormResponseBase> create1099FormWithHttpInfo(Create1099FormRequest requestParameters) throws ApiException {
        okhttp3.Call localVarCall = create1099FormValidateBeforeCall(requestParameters, null);
        Type localVarReturnType = new TypeToken<FormResponseBase>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call create1099FormAsync(Create1099FormRequest requestParameters, final ApiCallback<FormResponseBase> _callback) throws ApiException {
    ...
    */
    ...
    private okhttp3.Call delete1099FormValidateBeforeCall(Delete1099FormRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'requestParameters.xCorrelationId' is set
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling delete1099Form(Async)");
        }
    ...
    */
    ...
    private okhttp3.Call get1099FormValidateBeforeCall(Get1099FormRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'requestParameters.xCorrelationId' is set
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling get1099Form(Async)");
        }
     ...
     */
    public FormResponseBase get1099Form(Get1099FormRequest requestParameters) throws ApiException {
        ApiResponse<FormResponseBase> localVarResp = get1099FormWithHttpInfo(requestParameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FormResponseBase> get1099FormWithHttpInfo(Get1099FormRequest requestParameters) throws ApiException {
     ...
     */
    public okhttp3.Call get1099FormAsync(Get1099FormRequest requestParameters, final ApiCallback<FormResponseBase> _callback) throws ApiException {
    ...
    */
    ...
    private okhttp3.Call get1099FormPdfValidateBeforeCall(Get1099FormPdfRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'requestParameters.xCorrelationId' is set
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling get1099FormPdf(Async)");
        }
     ...
     */
    public FormResponseBase get1099FormPdf(Get1099FormPdfRequest requestParameters) throws ApiException {
        ApiResponse<FormResponseBase> localVarResp = get1099FormPdfWithHttpInfo(requestParameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FormResponseBase> get1099FormPdfWithHttpInfo(Get1099FormPdfRequest requestParameters) throws ApiException {
     ...
     */
    public okhttp3.Call get1099FormPdfAsync(Get1099FormPdfRequest requestParameters, final ApiCallback<FormResponseBase> _callback) throws ApiException {
    ...
    */
    ...
    private okhttp3.Call list1099FormsValidateBeforeCall(List1099FormsRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'requestParameters.xCorrelationId' is set
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling list1099Forms(Async)");
        }
    ...
    * @param $orderBy A comma separated list of sort statements in the format (fieldname) [ASC|DESC], for example issuerReferenceId ASC.    Supported sorting fields are:         issuerReferenceId       taxYear       createdAt       firstPayeeName      updatedAt (optional)</param>
    */
    ...
    */
    ...
    private okhttp3.Call update1099FormValidateBeforeCall(Update1099FormRequest requestParameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'requestParameters.xCorrelationId' is set
        if (requestParameters.getXCorrelationId() == null) {
            throw new ApiException("Missing the required parameter 'requestParameters.xCorrelationId' when calling update1099Form(Async)");
        }
     ...
     */
    public FormResponseBase update1099Form(Update1099FormRequest requestParameters) throws ApiException {
        ApiResponse<FormResponseBase> localVarResp = update1099FormWithHttpInfo(requestParameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FormResponseBase> update1099FormWithHttpInfo(Update1099FormRequest requestParameters) throws ApiException {
     ...
     */
    public okhttp3.Call update1099FormAsync(Update1099FormRequest requestParameters, final ApiCallback<FormResponseBase> _callback) throws ApiException {

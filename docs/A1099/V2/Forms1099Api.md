...
public class Example {
    public static void main(String[] args) {
        ...
        String xCorrelationId = "8dc909fe-720e-43fb-b983-58faed44f2fa"; // String | Unique correlation Id in a GUID format
...
public class Example {
    public static void main(String[] args) {
        ...
        Forms1099Api apiInstance = new Forms1099Api(apiClient);
        String avalaraVersion = "2.0.0"; // String | API version
        String xCorrelationId = "ad4f746f-04e3-4a59-8f2a-71982cba7d13"; // String | Unique correlation Id in a GUID format
        String xAvalaraClient = "Swagger UI; 22.1.0"; // String | Identifies the software you are using to call this API. For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
...
public class Example {
    public static void main(String[] args) {
        ...
        String avalaraVersion = "2.0.0"; // String | API version
        String xCorrelationId = "275dadca-90a3-446a-b0fa-bc0dbaa2b6ef"; // String | Unique correlation Id in a GUID format
        String xAvalaraClient = "Swagger UI; 22.1.0"; // String | Identifies the software you are using to call this API. For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        String avalaraVersion = "2.0.0"; // String | API version
        String xCorrelationId = "90f6f993-5bc8-491a-a091-0a9796c654b6"; // String | Unique correlation Id in a GUID format
        String xAvalaraClient = "Swagger UI; 22.1.0"; // String | Identifies the software you are using to call this API. For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        String xCorrelationId = "c159dc0f-6a68-4e21-921f-125572625a71"; // String | Unique correlation Id in a GUID format
        String xAvalaraClient = "Swagger UI; 22.1.0"; // String | Identifies the software you are using to call this API. For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        String xCorrelationId = "75d30018-83d1-41b9-b7b4-6de919434c8b"; // String | Unique correlation Id in a GUID format
        String xAvalaraClient = "Swagger UI; 22.1.0"; // String | Identifies the software you are using to call this API. For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | 
        String avalaraVersion = "2.0.0"; // String | API version
        String xCorrelationId = "31ca64fc-d116-4f15-b49f-4877baa12e4a"; // String | Unique correlation Id in a GUID format
        String xAvalaraClient = "Swagger UI; 22.1.0"; // String | Identifies the software you are using to call this API. For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .
        Get1099Form200Response get1099Form200Response = new Get1099Form200Response(); // Get1099Form200Response | 
        try {

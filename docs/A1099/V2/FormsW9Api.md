...
> IW9FormDataModelsOneOf createW9Form(avalaraVersion, xCorrelationId, xAvalaraClient, iw9FormDataModelsOneOf)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            IW9FormDataModelsOneOf result = apiInstance.createW9Form(avalaraVersion, xCorrelationId, xAvalaraClient, iw9FormDataModelsOneOf);
...
> IW9FormDataModelsOneOf getW9Form(id, avalaraVersion, xCorrelationId, xAvalaraClient)
...
> String uploadW9Files(id, avalaraVersion, xCorrelationId, xAvalaraClient, _file)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            String result = apiInstance.uploadW9Files(id, avalaraVersion, xCorrelationId, xAvalaraClient, _file);
            System.out.println(result);
        } catch (ApiException e) {
